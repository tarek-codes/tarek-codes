...
Computer Science & Engineering graduate with hands-on experience in **Machine Learning, Software Engineering, Data Science, NLP, and Full-Stack Development**.

Currently a **Junior AI Engineer at Betopia Limited**, working on production-oriented AI solutions, RAG systems, ML pipelines, APIs, and scalable software applications.

I focus on building practical, reliable systems that combine **strong engineering fundamentals with data-driven intelligence**.
...
<img src="https://skillicons.dev/icons?i=nextjs,react,tailwind,nodejs,express,django,fastapi,laravel" />
...
<img src="https://skillicons.dev/icons?i=postgresql,mysql,mongodb,docker,git,github,postman,figma" />

`ChromaDB` `Firecrawl` `Celery` `Playwright` `Locust` `Jira` `Excel`
...
<details>
<summary><strong>XEB-FuseNet — Multimodal Thoracic Disease Diagnosis</strong></summary>
...
* Designed modality-specific encoders for CXR, ECG, and laboratory data.
* Implemented hierarchical softmax attention fusion.
* Applied Grad-CAM for interpretability.
* Used DeLong's Test for statistical validation.

</details>

<details>
<summary><strong>MycoPredict — Mushroom Edibility Classification</strong></summary>
...
* Performed preprocessing, feature cleaning, encoding, and EDA.
...
<details>
<summary><strong>Word2Sense — NLP Representation Research</strong></summary>
...
* Evaluated machine learning and neural approaches.
* Best result achieved using **BiLSTM + Skip-gram**.

</details>

<details>
<summary><strong>PetSphere — Pet Adoption & Management System</strong></summary>
...
<details>
<summary><strong>VibeSpot — Venue & Event Discovery Platform</strong></summary>
...
* Built collaboratively in a **5-member Agile team**.
